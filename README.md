...
- Shoot enemies, chain combos, collect powerups, and keep escaped ravens low for better stars.
- Boss stages introduce the Raven King as a high-health gate.
- Run reports award coins based on score, stage reached, accuracy, stars, boss kills, and drops, then point directly to useful armory actions.
